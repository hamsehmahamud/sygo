      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-20">
        <div className="max-w-3xl space-y-10">
          <motion.div
            ...
            className="inline-flex items-center gap-3 px-5 py-2.5 rounded-2xl glass-effect border-sygo-red/10 dark:border-white/5"
          >
            ...
            <span className="text-sygo-red dark:text-sygo-yellow text-[11px] font-black uppercase tracking-[0.2em]">
          ...
          <div className="space-y-4">
            <motion.h1
              ...
              className="text-sygo-red-dark dark:text-white text-7xl sm:text-8xl md:text-9xl font-black leading-[0.85] tracking-tighter"
            >
            ...
            <motion.p
              ...
              className="text-sygo-red-dark/70 dark:text-slate-400 text-xl md:text-2xl font-medium leading-relaxed max-w-xl"
            >
          ...
          >
            <button className="group relative px-10 py-5 bg-sygo-red text-white text-lg font-black rounded-2xl shadow-2xl shadow-sygo-red/20 transition-all hover:scale-105 active:scale-95 overflow-hidden">
            ...
            <button className="px-10 py-5 glass-effect text-sygo-red-dark dark:text-white text-lg font-black rounded-2xl hover:bg-sygo-yellow/20 transition-all active:scale-95">
              Learn More
            </button>
          </motion.div>
        </div>
