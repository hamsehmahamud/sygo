...
const Categories: React.FC = () => {
  return (
    <section className="py-24 bg-sygo-yellow-light dark:bg-slate-800 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-5xl font-black text-sygo-red-dark dark:text-white mb-4 tracking-tight">Our Categories</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {categories.map((cat, index) => (
            <div key={index} className="group relative p-8 rounded-[3rem] border border-sygo-red/10 dark:border-white/5 hover:border-sygo-yellow/30 hover:shadow-2xl hover:shadow-sygo-yellow/5 transition-all duration-500 text-center flex flex-col items-center overflow-hidden bg-white dark:bg-slate-900">
