      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {categories.map((cat, index) => (
            <div key={index} className="group relative p-6 sm:p-8 rounded-[2rem] sm:rounded-[3rem] border border-sygo-red/10 dark:border-white/5 hover:border-sygo-yellow/30 hover:shadow-2xl hover:shadow-sygo-yellow/5 transition-all duration-500 text-center flex flex-col items-center overflow-hidden bg-slate-50 dark:bg-[#0a0a0a]">
