...
const DonationSection: React.FC = () => {
  ...
  return (
    <section className="py-16 sm:py-24 bg-white dark:bg-black relative overflow-hidden">
      {/* Decorative Elements */}
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    {amounts.map((amount) => (
                      <button
                        key={amount}
                        className="group relative py-4 px-2 bg-white dark:bg-[#0a0a0a] border-2 border-transparent rounded-2xl font-black text-sygo-red-dark dark:text-white hover:border-sygo-yellow hover:bg-slate-50 dark:hover:bg-black transition-all shadow-sm overflow-hidden"
                      >
